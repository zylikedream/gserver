...
const file_bag_proto_rawDesc = "" +
	"\n" +
	"\tbag.proto\x12\x0fgalaxy.protocol\x1a\x11msg_options.proto\"\x14\n" +
	"\n" +
	"ReqBagInfo:\x06\xa8\xac\x1d\x89\xa4\x01\"F\n" +
	"\n" +
	"RspBagInfo\x120\n" +
	"\x05goods\x18\x01 \x03(\v2\x1a.galaxy.protocol.PGoodInfoR\x05goods:\x06\xa8\xac\x1d\x8a\xa4\x01\"6\n" +
	"\tPGoodInfo\x12\x17\n" +
	"\aprop_id\x18\x01 \x01(\x05R\x06propId\x12\x10\n" +
	"\x03num\x18\x02 \x01(\x03R\x03num\"P\n" +
	"\x0fNotifyBagUpdate\x125\n" +
	"\x05goods\x18\x01 \x03(\v2\x1f.galaxy.protocol.PBagGoodUpdateR\x05goods:\x06\xa8\xac\x1d\x8b\xa4\x01\"K\n" +
	"\x0fNotifyBagReward\x120\n" +
	"\x05goods\x18\x01 \x03(\v2\x1a.galaxy.protocol.PGoodInfoR\x05goods:\x06\xa8\xac\x1d\x8c\xa4\x01\"T\n" +
	"\x0ePBagGoodUpdate\x12\x17\n" +
	"\aprop_id\x18\x01 \x01(\x05R\x06propId\x12\x17\n" +
	"\apre_num\x18\x02 \x01(\x03R\x06preNum\x12\x10\n" +
	"\x03num\x18\x03 \x01(\x03R\x03numB\tZ\a./pb;pbb\x06proto3"
