...
type RspBasicInfo struct {
	...
	CreateTm int64  `protobuf:"varint,3,opt,name=create_tm,json=createTm,proto3" json:"create_tm"` // 创角时间
	Head     string `protobuf:"bytes,4,opt,name=head,proto3" json:"head"`
	Level    int32  `protobuf:"varint,5,opt,name=level,proto3" json:"level"` // 玩家等级
}
...
type ReqBasicSetHead struct {
	...
	Head string `protobuf:"bytes,1,opt,name=head,proto3" json:"head"`
}
...
type NotifyRoleLevelUp struct {
	...
	OldLevel   int32    `protobuf:"varint,1,opt,name=old_level,json=oldLevel,proto3" json:"old_level"`
	NewLevel   int32    `protobuf:"varint,2,opt,name=new_level,json=newLevel,proto3" json:"new_level"`
	OldExp     int64    `protobuf:"varint,3,opt,name=old_exp,json=oldExp,proto3" json:"old_exp"`
	NewExp     int64    `protobuf:"varint,4,opt,name=new_exp,json=newExp,proto3" json:"new_exp"`
	UnlockDesc []string `protobuf:"bytes,5,rep,name=unlock_desc,json=unlockDesc,proto3" json:"unlock_desc"`
}
