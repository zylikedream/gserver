...
const (
	...
	ChannelType_CHANNEL_TYPE_GUILD   ChannelType = 2
)
...
type ReqChatSendChannel struct {
	...
	ChannelType ChannelType `protobuf:"varint,1,opt,name=channel_type,json=channelType,proto3,enum=galaxy.protocol.ChannelType" json:"channel_type"`
	Content     string      `protobuf:"bytes,2,opt,name=content,proto3" json:"content"`
}
...
var file_chat_proto_goTypes = []interface{}{
	(ChannelType)(0),              // 0: galaxy.protocol.ChannelType
