...
type GardenItemCost struct {
    Id int32
    Num int32
}

const TypeId_GardenItemCost = -1742341831

func (*GardenItemCost) GetTypeId() int32 {
    return -1742341831
}

func NewGardenItemCost(_buf map[string]interface{}) (_v *GardenItemCost, err error) {
    _v = &GardenItemCost{}
