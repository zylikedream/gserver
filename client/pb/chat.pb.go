...
type PChatMsg struct {
	...
	Sender        *PRolePublic           `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty"`
...
type RspChatInit struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	LobbyId        int32                  `protobuf:"varint,1,opt,name=lobby_id,json=lobbyId,proto3" json:"lobby_id,omitempty"`
	WorldMessages  []*PChatMsg            `protobuf:"bytes,2,rep,name=world_messages,json=worldMessages,proto3" json:"world_messages,omitempty"`
	SystemMessages []*PChatMsg            `protobuf:"bytes,3,rep,name=system_messages,json=systemMessages,proto3" json:"system_messages,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type RspChatPrivateHistory struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Messages      []*PChatMsg            `protobuf:"bytes,1,rep,name=messages,proto3" json:"messages,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type NotifyChatPrivate struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Message       *PChatMsg              `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
