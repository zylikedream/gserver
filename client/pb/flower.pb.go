...
type PFlowerInfo struct {
	...
	State         FlowerState            `protobuf:"varint,2,opt,name=state,proto3,enum=galaxy.protocol.FlowerState" json:"state,omitempty"`
	StateTime     int64                  `protobuf:"varint,3,opt,name=state_time,json=stateTime,proto3" json:"state_time,omitempty"`
	Level         int32                  `protobuf:"varint,4,opt,name=level,proto3" json:"level,omitempty"`                             // 当前等级
	BreakStage    int32                  `protobuf:"varint,5,opt,name=break_stage,json=breakStage,proto3" json:"break_stage,omitempty"` // 突破阶段
...
type RspFlowerInfo struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Flowers       []*PFlowerInfo         `protobuf:"bytes,1,rep,name=flowers,proto3" json:"flowers,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RspFlowerStartBreed struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Flower        *PFlowerInfo           `protobuf:"bytes,1,opt,name=flower,proto3" json:"flower,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
