...
type GardenGoodStack struct {
    Id int32
    Num int32
}

const TypeId_GardenGoodStack = 1060150066

func (*GardenGoodStack) GetTypeId() int32 {
    return 1060150066
}

func NewGardenGoodStack(_buf map[string]interface{}) (_v *GardenGoodStack, err error) {
    _v = &GardenGoodStack{}
